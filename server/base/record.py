...
def get_base_table_records(
    ...
    def get_records(page_token: str | None):
        ...
        res: ListAppTableRecordResponse = base_client.base.v1.app_table_record.list(req.build())
...
class IRecord(object):
    ...
    def to_app_record(self):
        ...
        fields = {cell.get_field().name: cell.to_bitable_value() for cell in self.cells.values() if cell.auto == False}
        return {
            "fields": fields
        }
