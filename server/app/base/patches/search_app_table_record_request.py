...
from typing import *
from baseopensdk.core.model import BaseRequest
from baseopensdk.core.enum import HttpMethod, AccessTokenType
...
class SearchAppTableRecordRequestBuilder(object):
    ...
    def user_id_type(self, user_id_type: str) -> "SearchAppTableRecordRequestBuilder":
        self._search_app_table_record_request.page_size = user_id_type
