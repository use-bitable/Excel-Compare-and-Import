...
def test_user_token():
    personal_base_token = "pt-ApsdmDzoKc9vpu66XbUwchLdLklfpwsXY-3c1GSVAQAAHICBXgIAQONoEbZF"
    assert serialize_security_key(personal_base_token) == "ApsdmDzoKc9vpu66XbUwchLdLklfpwsX"
